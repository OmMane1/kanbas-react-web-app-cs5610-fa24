    ...
    <div id="wd-dashboard">
      ...
      <div id="wd-dashboard-courses">
        <div className="wd-dashboard-course">
          <img src="images\reactjs.webp" alt="CS1234 React JS" width={200} />
          <div>
        ...
        <div className="wd-dashboard-course"><img src="images\Python-logo-notext.svg.png" alt="CS2345 Introduction to Python" width={200} />
          <div>
            <Link className="wd-dashboard-course-link"
        ...
        <div className="wd-dashboard-course"> <img src="images/Software Engineering.webp"alt="CS1356 Software Engineering" width={200} />
          <div>
            <Link className="wd-dashboard-course-link"
          ...
          <div className="wd-dashboard-course"> <img src="images\DSA.png"alt="CS1400 Data Structure and Algorithms" width={200} />
          <div>
            <Link className="wd-dashboard-course-link"
          ...
          <div className="wd-dashboard-course"> <img src="images\nlp.png" alt="CS1792 Natural Language Processing" width={200} />
          <div>
            <Link className="wd-dashboard-course-link"
          ...
          <div className="wd-dashboard-course"> <img src="images\toc.png"alt="CS1060 Theory of Computation" width={200} />
          <div>
            <Link className="wd-dashboard-course-link"
          ...
          <div className="wd-dashboard-course"> <img src="images\discrete-math.webp"alt=" CS2820 Discrete Mathematics" width={200} />
          <div>
            <Link className="wd-dashboard-course-link"
